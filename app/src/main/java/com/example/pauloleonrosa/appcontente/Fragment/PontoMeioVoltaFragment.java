 ...
 */
public class PontoMeioVoltaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.ponto_meio_volta, container, false);
            ...
            public void onClick(View view) {
                ...
                })
                {
                    protected Map<String, String> getParams() {
                        ...
                        MyData.put("fdescricao", "2"); //Add the data you'd like to send to the server.
                        return MyData;
                    }
                };
